...
import detector
from config import robot_middle_x, robot_middle_y, robot_ground_z, cam_approx_offset_x, cam_approx_offset_y
...
async def task():
    ...
    while True:
        ...
        if len(boxes) != 1:
            ...
            if abs(div_x_pixels) <10 and abs(div_y_pixels) < 10:
                cam_offset_x=robot_middle_x-calibrate_x
                cam_offset_y=robot_middle_y-calibrate_y
                print(f"Tuning: Cam offset = {(cam_offset_x, cam_offset_y)}")
