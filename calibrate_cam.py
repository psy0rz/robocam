...
async def task():
    ...
    #
    # config.low_cam_height = (delta_z * high_x_pix_per_mm) / (config.low_x_pix_per_mm - high_x_pix_per_mm) + config.calibration_box_height
    ...
    ### test
    print("TESTING")
    XXX: cube hoogte niet verwerkt in bovenstande procedure
